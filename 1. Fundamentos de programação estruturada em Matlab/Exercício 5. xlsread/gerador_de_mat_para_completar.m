...
%% Estágio 2: Criação da struct dados. 
...
% (Completando o Estágio 2) E se o usuário colocar um país que não existe na lista? Como fazer o
...
%% Estágio 4: SALVAR VARIÁVEIS EM .MAT
